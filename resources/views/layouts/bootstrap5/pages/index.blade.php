...
<html lang="es" data-bs-theme="light">
  <head>
    ...
    <link href="{{ asset('bootstrap5/carousel/carousel.css') }}" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-primary">
                            <i class="fa-solid fa-user-secret"></i> Iniciar sesión
                        </a>
  ...
  ================================================== -->
    ...
    <script
      src="{{ asset('bootstrap5/assets/dist/js/bootstrap.bundle.min.js') }}"
