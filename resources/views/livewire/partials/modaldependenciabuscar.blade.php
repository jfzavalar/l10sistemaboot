                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-group mt-3 mb-3">
                                    <input type="text" class="form-control" placeholder="Buscar dependencia" wire:model="searchdependencia">
                                </div>
                            </div>
                        </div>
                    </form>
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-outline-success btn-sm" wire:click="dependencia_agregar('{{ $dependencia->dependencia }}')" data-bs-toggle="modal" data-bs-target="#new-edit-Modal">
