<!-- Modal enviar correo -->
<div wire:ignore.self class="modal fade" id="enviar-correo-usuario-Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="">
                <div class="modal-header bg-success-subtle">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">
                        <i class="fa-solid fa-envelopes-bulk"></i> ENVIAR USUARIO Y PASSWORD
                    </h1>
