...
class Tokens extends Component
{
    ...
    public function render()
    {
        ...
        $lista_historial = DB::table('tbl_tokens_asignados')
            ->select('id','dni','datos','sede','dependencia','regimen','cargo','operativo','asignacion','idtoken','codtoken','operativo','asignacion','actaruta','fecha_expiracion','observacion','activo','created_user','updated_user')
            // ->where('activo',"0")
    ...
    public function cargarPDF2(){
        ...
        // dd($this->idindex);
        $instanciaTbl = Tbl_tokens_asignado::findOrFail($this->idindex);
    ...
    public function actualizar(){
        ...
        $this->reset('id','dni','datos','sede','dependencia','regimen','cargo','correo_personal','correo_institucional','cel_personal','cel_institucional','activo_per','fecha_expiracion','observacion','created_user','updated_user');
    ...
    public function reasignar2(){
        $instanciaTbl = Tbl_tokens_asignado::findOrFail($this->idtoken);
